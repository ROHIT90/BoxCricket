...
class TotoViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    deinit {
        self.ref.child("Toto").removeObserver(withHandle: _refHandle)
    ...
    func configureDatabase() {
        ...
        _refHandle = self.ref.child("Toto").observe(.childAdded, with: { [weak self] (snapshot) -> Void in
